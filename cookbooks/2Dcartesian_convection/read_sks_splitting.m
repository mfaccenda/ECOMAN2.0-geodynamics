...
splitpath='../../cookbooks/2Dcartesian_convection/splitting/';
%Path to output file 
outpath=splitpath;

filenumber='0001'; %set number for input split.*.staat and output files, string with 4 digits

%Coordinate system 
cartspher  = 1; % 1 (cartesian) vs 2 (polar/spherical)
dimensions = 2; % 2 (2D) vs 3 (3D)

Surface = 0e+3; %Set vertical coordinate of surface where to plot the seismic stations
