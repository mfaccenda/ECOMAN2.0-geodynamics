...
splitpath='../../cookbooks/3Dspherical_global/splitting/';
%Path to output file 
outpath=splitpath;

filenumber='0999'; %set number for input split.*.staat and output files, string with 4 digits

%Coordinate system 
cartspher  = 2; % 1 (cartesian) vs 2 (polar/spherical)
dimensions = 3; % 2 (2D) vs 3 (3D)

Surface = 2.2222e+0; %Set vertical coordinate of surface where to plot the seismic stations
